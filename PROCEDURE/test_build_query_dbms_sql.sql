--------------------------------------------------------
--  File created - Friday-February-24-2023   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Procedure BUILD_QUERY_DBMS_SQL
--------------------------------------------------------
set define off;

  CREATE OR REPLACE PROCEDURE "MCZBASE"."BUILD_QUERY_DBMS_SQL" (resultID IN varchar2, varUsername IN varchar2, searchJSON IN CLOB) 
as 
...
/
  ...
  GRANT EXECUTE ON "MCZBASE"."BUILD_QUERY_DBMS_SQL" TO PUBLIC;
