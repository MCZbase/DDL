  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "LOAD_SHAPES" as
...
for c1_rec in c1 loop
    select sdo_util.to_wktgeometry(shape) into wktshape from gis_us_counties where geoid = c1_rec.geoid;
