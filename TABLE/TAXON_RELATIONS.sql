  ...
  CREATE TABLE "TAXON_RELATIONS" 
   (	"TAXON_NAME_ID" NUMBER(10,0) NOT NULL ENABLE, 
	...
	"RELATION_AUTHORITY" VARCHAR2(45 CHAR), 
	 CONSTRAINT "FK_TAXONRELM_RELATION" FOREIGN KEY ("TAXON_RELATIONSHIP")
	  REFERENCES "CTTAXON_RELATION" ("TAXON_RELATIONSHIP") ENABLE, 
...
ALTER TABLE "TAXON_RELATIONS" ADD CONSTRAINT "PKEY_TAXON_RELATIONS" PRIMARY KEY ("TAXON_NAME_ID", "RELATED_TAXON_NAME_ID", "TAXON_RELATIONSHIP")
  USING INDEX "PKEY_TAXON_RELATIONS"  ENABLE