  ...
  CREATE TABLE "COLLECTION" 
   (	"COLLECTION_CDE" VARCHAR2(10) NOT NULL ENABLE, 
	...
	"WEB_LINK_TEXT" VARCHAR2(75 CHAR), 
...
ALTER TABLE "COLLECTION" ADD CONSTRAINT "PK_COLLECTION_ID" PRIMARY KEY ("COLLECTION_ID")
  USING INDEX "PK_COLLECTION_ID"  ENABLE
ALTER TABLE "COLLECTION" ADD CONSTRAINT "COLLECTION_UK1" UNIQUE ("COLLECTION_CDE")
  USING INDEX "IDX_COLLECTION_COLLECTION"  ENABLE;
