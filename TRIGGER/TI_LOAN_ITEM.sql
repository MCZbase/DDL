...
begin
    /* ERwin Builtin Wed May 05 11:26:47 2004 */
    /* Person R/212 Loan_Item ON CHILD INSERT RESTRICT */
    ...
    then
      raise_application_error(
        -20002,
        'Cannot INSERT "Loan_Item" because "Person" does not exist.'
      );
    end if;

    /* ERwin Builtin Wed May 05 11:26:47 2004 */
    /* Coll_Object R/196 Loan_Item ON CHILD INSERT RESTRICT */
    select count(*) into numrows
      from Coll_Object
      where
    ...
    then
      raise_application_error(
        -20002,
        'Cannot INSERT "Loan_Item" because "Coll_Object" does not exist.'
      );
    end if;

    /* ERwin Builtin Wed May 05 11:26:47 2004 */
    /* Loan R/195 Loan_Item ON CHILD INSERT RESTRICT */
    select count(*) into numrows
      from Loan
      where
    ...
    then
      raise_application_error(
        -20002,
        'Cannot INSERT "Loan_Item" because "Loan" does not exist.'
      );
    end if;
...
ALTER TRIGGER "TI_LOAN_ITEM" ENABLE