  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "VIEW_ALL_RELATIONS" ("COLLECTION_OBJECT_ID", "RELATED_COLL_OBJECT_ID", "BIOL_INDIV_RELATIONSHIP", "BIOL_INDIV_RELATION_REMARKS", "CREATED_BY", "BIOL_INDIV_RELATIONS_ID") AS 
