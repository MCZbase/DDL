  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "GET_TOP_TYPESTATUS_KIND" (collection_object_id in NUMBER )
return varchar2
...
begin
l_str := '';
open l_cur for 'select * from (
      select ct.category from citation ci
