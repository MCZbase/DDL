  ...
  CREATE OR REPLACE EDITIONABLE FUNCTION "GET_PUBLICATION_AUTHORS" 
(
  PUBLICATION_ID IN NUMBER  
) RETURN VARCHAR2 
--  Supporting the Publications part of the MCZ website  
--  Given a publication id, return the authorship string excluding editors 
--  @see get_publication_editors for editors.
AS 
